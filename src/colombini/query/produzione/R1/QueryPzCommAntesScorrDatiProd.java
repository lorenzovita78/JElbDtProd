 ...
 * @author GGraziani
 */
public class QueryPzCommAntesScorrDatiProd extends CustomQuery {
  ...
  //  sql.append(" select Collo , ncollo , LineaDestAbbreviata , Box, Pedana , odv , rigaOrdine ,  codSemilavorato , descAbb ,  Descrizione  , barcode ").append(
      ...
      StringBuilder commCondition=new StringBuilder(
                     ...
                     " and a.DataCommessa=").append(getFilterSQLValue(FilterFieldCostantXDtProd.FT_DATA)).append(addAND(inStatement(" linealogica ", FilterFieldCostantXDtProd.FT_LINEE)));
