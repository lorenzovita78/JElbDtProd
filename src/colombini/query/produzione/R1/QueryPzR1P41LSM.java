...
public class QueryPzR1P41LSM extends CustomQuery {
  ...
  public String toSQLString() throws QueryException {
    StringBuilder sql=new StringBuilder();
      ...
      sql.append("select trim(pselno), 1 n_collo,'P2MF1' linea, clboxn, clpeda, psridn, 0, clpadr articolo, left(cldesc , 25) concat ' ' concat sum(int(pscnqt)) desc1,cldesc concat ' QTA: ' concat sum(int(pscnqt)) desc2,trim(psproj) concat trim(pselno) barcode \n").append(
