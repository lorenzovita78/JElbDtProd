...
import static colombini.elabs.ElabGestMancantiFromVDL.DESCRCOMM;
import static colombini.elabs.ElabGestMancantiFromVDL.FORCENCOMM;
 ...
 * @author lvita
 */
public class ElabGestMancantiCompleto extends ElabClass{
...
//    Date dataFin=getDataOraRif(dataRf,ELABPOM);
  ...
  private static final Logger _logger = Logger.getLogger(ElabGestMancantiCompleto.class);
