...
public class MsgUploadColloInfoDetail extends  ABeanPersCRUD4Middleware{
  ...
  public final static String FSOURCE__DELIVERYSTATE           ="DELIVERYSTATE";
  ...
  public final static String FDEST__DELIVERYSTATE           ="DELIVERYSTATE";
  ...
  public void loadInfoBeanFromSource(Connection con) throws SQLException {
    ...
    if(obj!=null && obj.length>0){
      ...
      this.setDELIVERYSTATE(ClassMapper.classToClass(obj[48],Long.class));
      this.setINSERTDATE();
    }
  ...
  public Map<String, Object> getFieldValuesMapSource() {
    ...
    m.put(FSOURCE__DELIVERYSTATE, this.DELIVERYSTATE);
  ...
  public Map<String, Object> getFieldValuesMapDestination() {
    ...
    m.put(FDEST__DELIVERYSTATE, this.DELIVERYSTATE);
  ...
  public List<Integer> getFieldTypesSource() {
    ...
    l.add(Types.NUMERIC);  //DELIVERYSTATE
    l.add(Types.VARCHAR);
