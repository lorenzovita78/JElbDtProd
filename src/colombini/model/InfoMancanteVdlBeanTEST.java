 ...
 * @author lvita
 */
public class InfoMancanteVdlBeanTEST  implements IBeanPersSIMPLE{
  
  public final static String TABNAME="ZDPVD2";
  ...
  public InfoMancanteVdlBeanTEST(){
    this.estero=Boolean.FALSE;
    this.tipoCommessa="";
  }
  
  public InfoMancanteVdlBeanTEST(Date dataRif){
