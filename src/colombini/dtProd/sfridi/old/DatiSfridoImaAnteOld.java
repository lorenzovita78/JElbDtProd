 ...
 * @author lvita
 */
public class DatiSfridoImaAnteOld implements ISfridoInfo {
  ...
  private List loadDatiFromDb(Date dataInizio,Date dataFine) throws ElabException{
    ...
    try {
      ...
      _logger.error(" Problemi di connessione con db :"+ColomConnectionsCostant.DBIMAANTE+" --> "+ex.getMessage());
      ...
      if(con!=null)
        ...
        _logger.error(" Problemi con la chiusura della connessione con db :"+ColomConnectionsCostant.DBIMAANTE+" --> "+ex.getMessage());
      }
    }
  ...
  private static final Logger _logger = Logger.getLogger(DatiSfridoImaAnteOld.class); 
}
