 ...
 * @author lvita
 */
public class DatiSfridoOtmGalOld implements ISfridoInfo {
  ...
  private List getListInfoOttimizzatore(List<File> filesOtt) throws ElabException{
    ...
    for(File f: filesOtt){
        ...
        record.add(DateUtils.getOraLong(data));
  ...
  private List getOptiFiles(Date dataInizio,Date dataFine){
    ...
    String pathfile=(String) prop.get(NameElabs.PATHFILEOTTIMIZZG1P2);
  ...
  private static final Logger _logger = Logger.getLogger(DatiSfridoOtmGalOld.class); 
