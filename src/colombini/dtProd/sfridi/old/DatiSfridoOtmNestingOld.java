 ...
 * @author lvita
 */
public class DatiSfridoOtmNestingOld implements ISfridoInfo {
  ...
  private List loadDatiFromDb(Date dataInizio,Date dataFine) throws ElabException{
    ...
    try {
      ...
      StringBuilder qry=new StringBuilder(
              " Select MIN(dataRif) as dataR,MIN(oraRif) as oraR, ").append(
                ...
                "\n MIN(sheetsM2) as supdisp, MIN(panelsM2) as suput,SUM(pinzM2) as difetti, ").append(
                " SUM(lamaM2+pinzM2) as sfridoFisio, isnull(min(b.m2resti),0) restiM2,  ").append(
                " SUM(botolM2+lateralM2) as sfridoEff,0 ").append(
                "\n FROM ( ").append(
  ...
  private static final Logger _logger = Logger.getLogger(DatiSfridoOtmNestingOld.class); 
}
