 ...
 * @author lvita
 */
public class AvProdStrettoiP2_NEW extends AvProdLineeOnTAP  {

  public final static String CENTRO="01115";  
    
   @Override
  public String getCodLineaOnTAP() {
    return TAPWebCostant.CDL_STRETTOIO_EDPC;  //To change body of generated methods, choose Tools | Templates.
  }
  ...
  public void prepareDtProd(Connection conAs400) throws DatiCommLineeException {
    ...
    try{
      ...
      List lineeStrettoio=new ArrayList();
      lineeStrettoio.add("06030");
      lineeStrettoio.add("06031"); 
      lineeStrettoio.add("06033"); 
      lineeStrettoio.add("06034");
      lineeStrettoio.add("06039");
      ...
      qry.setFilter(FilterFieldCostantXDtProd.FT_LINEA,lineeStrettoio.toString());
...
//  }
  ...
  private static final Logger _logger = Logger.getLogger(AvProdStrettoiP2_NEW.class);
