...
import colombini.query.datiComm.avanzamento.QueryProdCommAvzPriessOne;
 ...
 * @author lvita
 */
public class AvProdPriessOne extends AvProdLineaStd{
  ...
  private static final Logger _logger = Logger.getLogger(AvProdPriessOne.class);
}
